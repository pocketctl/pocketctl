...
export const MEMORY_TEST_DATABASE_TABLES = [
  'memory_git_attestation_keys',
  'memory_git_snapshot_keys',
  'memory_git_sync_principals',
  'memory_git_run_receipts',
  'memory_git_merge_receipts',
  'memory_git_request_reservations',
  'memory_git_connections',
  'memory_git_actor_mappings',
  'memory_git_asset_bindings',
  'memory_git_snapshots',
  'memory_git_snapshot_assets',
  'memory_git_revision_links',
  'memory_git_runs',
  'memory_git_inbox',
  'memory_git_outbox',
  'memory_git_import_proposals',
  'memory_git_conflicts',
  'memory_git_review_decisions',
  'memory_git_audit_events',
